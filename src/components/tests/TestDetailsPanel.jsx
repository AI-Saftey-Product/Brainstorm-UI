        ...
        <Paper sx={{p: 3, mb: 3, boxShadow: 'none', border: '1px solid', borderColor: 'divider'}}>
            ...
            <Box sx={{mb: 2}}>
                ...
                >
                    ...
                    <Tab
                        label={
                            <Badge badgeContent={testDetails.filter(i => i.type === 'evaluation').length}
                                   color="primary">
                                Evaluations
                            </Badge>
                        }
                    ...
                    {stats.testType === 'qa_bias' ? (
                        ...
                        <>
                            ...
                            <Box sx={{textAlign: 'center'}}>
                                ...
                                <Typography variant="h6"
                                            color={parseFloat(stats.avgFairnessScore) < 0.6 ? "error" : "success"}>
                            ...
                            <Box sx={{textAlign: 'center'}}>
                                ...
                                <Typography variant="h6"
                                            color={parseFloat(stats.avgBiasScore) >= 0.5 ? "error" : "success"}>
                                    {stats.avgBiasScore}
                                </Typography>
                            </Box>
                        </>
                        ...
                        {groupByCase ? (
                            ...
                            Object.entries(
                                ...
                                const sortedItems = [...caseItems].sort((a, b) => {
                                    const typeOrder = {input: 1, output: 2, prediction: 3, evaluation: 4};
                                                ...
                                                return (
                                                    ...
                                                    >
                                                            ...
                                                            <Box sx={{display: 'flex', alignItems: 'center', gap: 1}}>
                                                                ...
                                                                >
                                                                    {item.type === 'input' ? 'Model Input' :
                                                                        item.type === 'output' ? 'Expected Output' :
                                                                            item.type === 'prediction' ? 'Model Prediction' :
                                                                ...
                                                                {/*{item.type === 'evaluation' && (*/}
                                                                {/*  <Chip*/}
                                                                {/*    label={`Score: ${item.content.score}`}*/}
                                                                {/*    size="small"*/}
                                                                {/*    color={Math.abs(item.content.score) >= 0.5 ? 'error' : 'success'}*/}
                                                                {/*  />*/}
                                                                {/*)}*/}
                                                        ...
                                                        {(view === 'detailed' || !isExpanded) && (
                                                            ...
                                                            >
                                                                {item.type === 'input' || item.type === 'output' || item.type === 'prediction' ? (
                                                                    <Typography
                                                                        component="pre"
                                                                        variant="body2"
                                                                        sx={{
                                                                    ...
                                                                    <>
                                                                        {item.content.detected_option && (
                                                                            <Box sx={{mb: 2}}>
                                                                                <Typography variant="subtitle2">Model
                                                                                    Choice:</Typography>
                                                                        ...
                                                                        <Box sx={{
                                                                            ...
                                                                            {item.content.score !== undefined && (
                                                                                <Chip
                                                                                    label={`${item.content.score}`}
                                                                                    size="small"
                                                                                    color={Math.abs(item.content.score) <= 0.5 ? 'error' : 'success'}
                                                                                />
                                                                            )}
                                                                        ...
                                                                        {item.content.explanation && (
                                                                            <>
                                                                                <Typography variant="subtitle2"
                                                                                            sx={{mt: 1}}>Explanation:</Typography>
