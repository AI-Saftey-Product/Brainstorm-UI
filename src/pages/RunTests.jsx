                            ...
                            <Box sx={{margin: 1, py: 2}}>
                                ...
                                <Grid container spacing={2}>
                                    <Grid item xs={12} md={6}>
                                        {item.metrics && (
                                            <Box sx={{mt: 2}}>
                                                <Typography variant="subtitle2" gutterBottom>Performance
                                                    Metrics</Typography>
                                                <Box component="dl" sx={{
                                                    display: 'grid',
                                        ...
                                        <Card variant="outlined">
                                            <CardContent>
                                                ...
                                                <Box sx={{display: 'flex', gap: 3, flexWrap: 'wrap'}}>
                                                    <Box>
                                                        <Typography variant="body2" color="text.secondary">Total
                                                            Tests</Typography>
                                                        <Typography variant="h5">{testResults.length}</Typography>
                                                    </Box>
                                                    <Box>
                                                        <Typography variant="body2"
                                                                    color="text.secondary">Passed</Typography>
                                                    ...
                                                    <Box>
                                                        <Typography variant="body2"
                                                                    color="text.secondary">Failed</Typography>
